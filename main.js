  ...
  50% {
    ...
    opacity: 1;
        ...
        <div style="position: relative; width: 100%; height: 100vh; 
            ...
            <button class="secondary-btn" id="nextFromCake" style="
                position: absolute;
                bottom: 25%;
                left: 50%;
                transform: translate(-50%, 50%); 
    ...
    function drawCake() {
        ...
        ctx.textAlign = 'center';
        ctx.textBaseline = 'middle';
        ctx.fillText('21 years', centerX, canvas.height * 0.47);
    }
    ...
    function drawMessage() {
        if (messageOpacity > 0) {
            ...
            ctx.fillText('My Love', centerX, messageY + canvas.width * 0.07);
...
function renderExitScreen() {
    ...
    app.innerHTML = `
        ...
        <body>
            ...
            <div class="container">
                <header class="header">
                    <h1 class="title">Thank You Najme </h1>
